                ...
                <div className="container seo_service_info">
                    ...
                    <div className="seo_fact_info">
                        <div className="seo_fact_item wow fadeIn" data-wow-delay="0.1s">
                            <div className="text">
                                <div className="counter one" data-countup>100</div>
                                <p className="counter_desc">React</p>
                            </div>
                        </div>
                        <div className="seo_fact_item wow fadeIn" data-wow-delay="0.1s">
                            <div className="text">
                                <div className="counter two" data-countup>100</div>
                                <p className="counter_desc">HTML</p>
                            </div>
                        </div>
                        <div className="seo_fact_item wow fadeIn" data-wow-delay="0.1s">
                            <div className="text">
                                <div className="t_color counter three" data-countup>100</div>
                                <p className="counter_desc">CSS</p>
                            </div>
                        </div>
